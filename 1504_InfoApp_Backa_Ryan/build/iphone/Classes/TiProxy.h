...
//Rare exceptions to indicate a bug in the _k1504_infoapp_backa_ryan code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1504_InfoApp_Backa_Ryan proxies.
 */
