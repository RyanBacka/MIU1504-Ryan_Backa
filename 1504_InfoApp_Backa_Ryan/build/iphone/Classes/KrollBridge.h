...
@interface k1504_InfoApp_Backa_RyanObject : KrollCoverageObject {
#else
@interface k1504_InfoApp_Backa_RyanObject : KrollObject {
#endif
@private
...
extern NSString * k1504_InfoApp_Backa_Ryan$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1504_InfoApp_Backa_RyanObject *_k1504_infoapp_backa_ryan;
    KrollObject* console;
	BOOL shutdown;
