...
// in simulator we redefine to format for k1504_InfoApp_Backa_Ryan Developer console
...
{\
	NSString * exceptionName = [@"org.k1504_infoapp_backa_ryan." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1504_infoapp_backa_ryan";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1504_InfoApp_Backa_RyanNativeItemNone = -1, 
	UIk1504_InfoApp_Backa_RyanNativeItemSpinner = -2,
	UIk1504_InfoApp_Backa_RyanNativeItemProgressBar = -3,
	
	UIk1504_InfoApp_Backa_RyanNativeItemSlider = -4,
	UIk1504_InfoApp_Backa_RyanNativeItemSwitch = -5,
	UIk1504_InfoApp_Backa_RyanNativeItemMultiButton = -6,
	UIk1504_InfoApp_Backa_RyanNativeItemSegmented = -7,
	
	UIk1504_InfoApp_Backa_RyanNativeItemTextView = -8,
	UIk1504_InfoApp_Backa_RyanNativeItemTextField = -9,
	UIk1504_InfoApp_Backa_RyanNativeItemSearchBar = -10,
	
	UIk1504_InfoApp_Backa_RyanNativeItemPicker = -11,
	UIk1504_InfoApp_Backa_RyanNativeItemDatePicker = -12,
	
	UIk1504_InfoApp_Backa_RyanNativeItemInfoLight = -13,
	UIk1504_InfoApp_Backa_RyanNativeItemInfoDark = -14,
	
	UIk1504_InfoApp_Backa_RyanNativeItemDisclosure = -15,
	
	UIk1504_InfoApp_Backa_RyanNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1504_InfoApp_Backa_Ryan instances of
