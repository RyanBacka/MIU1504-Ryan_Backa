 ...
 * to send analytic data that can be viewed on the k1504_InfoApp_Backa_Ryan Dashboard.
 *
 * For information on getting started with k1504_InfoApp_Backa_Ryan Platform Services,
