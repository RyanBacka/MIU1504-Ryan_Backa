...
@interface k1501_AboutMe_Backa_RyanObject : KrollCoverageObject {
#else
@interface k1501_AboutMe_Backa_RyanObject : KrollObject {
#endif
@private
...
extern NSString * k1501_AboutMe_Backa_Ryan$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1501_AboutMe_Backa_RyanObject *_k1501_aboutme_backa_ryan;
    KrollObject* console;
	BOOL shutdown;
