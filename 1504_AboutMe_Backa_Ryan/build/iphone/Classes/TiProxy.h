...
//Rare exceptions to indicate a bug in the _k1501_aboutme_backa_ryan code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1501_AboutMe_Backa_Ryan proxies.
 */
