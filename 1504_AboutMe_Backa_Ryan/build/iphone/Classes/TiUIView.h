...
/**
 Base class for all k1501_AboutMe_Backa_Ryan views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1501_AboutMe_Backa_Ryan view hierarchy (such as wrapped iOS UIViews) was touched.
