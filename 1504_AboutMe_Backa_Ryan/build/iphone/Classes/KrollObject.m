...
//@interface k1501_AboutMe_Backa_RyanObject : NSObject
//@end

@interface k1501_AboutMe_Backa_RyanObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1501_AboutMe_Backa_RyanObject class]])
		{
			for (NSString *key in [[(k1501_AboutMe_Backa_RyanObject*)o modules] allKeys])
			{
